...
export class BN {
  static TO_WEI_FACTOR = new BN(10).pow(WEI_DECIMALS)
  static MIN_WEI_STR = new BN(0.1).pow(WEI_DECIMALS).toString()
  static FROM_WEI_FACTOR = new BN(0.1).pow(WEI_DECIMALS)
